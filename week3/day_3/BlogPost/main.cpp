...
int main()
{
    ...
    std::cout << FirstBlog.getAuthor() << " " << FirstBlog.getTitle() << " " << FirstBlog.getText() << " " << FirstBlog.getPublicationDate() << std::endl;
    std::cout << SecondBlog.getAuthor() << " " << SecondBlog.getTitle() << " " << SecondBlog.getText() << " " << SecondBlog.getPublicationDate() << std::endl;
    std::cout << ThirdBlog.getAuthor() << " " << ThirdBlog.getTitle() << " " << ThirdBlog.getText() << " " << ThirdBlog.getPublicationDate() << std::endl;
